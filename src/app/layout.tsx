    ...
    <html lang="en">
      <PlausibleProvider domain="oliverrees.co.uk">
        <body className={inter.className + " dark:bg-black"}>
          <div className="lg:w-96 md:w-48 h-20 md:h-auto fixed lg:z-0 z-20 flex md:items-start md:min-h-screen md:bg-white md:dark:bg-black w-full md:flex-col dark:text-white justify-between bg-gray-100 dark:bg-black">
            <Link
              href="/"
          ...
          <div className="pt-32 md:ml-48 lg:ml-96 md:pt-0 flex flex-col relative lg:z-10">
            {children}
          </div>
        </body>
      </PlausibleProvider>
